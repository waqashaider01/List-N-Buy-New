      ...
      <div class="row">
          ...
          <div class="col-md-4 mt-4">
            ...
            <div class="sectionblock space long-value-input-container">
              ...
              <span style="position: absolute; right: -10px">
                ...
                ></i> -->
                   <i class="bi bi-lock  showclosesec"  onclick=" showclosesecond()" style="font-size: 20px;"></i>
                <i class="bi bi-unlock  showopensec" style="display: none; font-size: 20px;" onclick=" showopensecond()"   ></i>
              </span>
            </div>
        ...
        <div class="row d-flex justify-content-center">
          <div class="col-md-4 mt-3 backlog">
            <a href="/login"
              ><img src="{{url('frontend\img\backtisign.png')}}" alt="" class="pb-1 forward_back_icon"/>
