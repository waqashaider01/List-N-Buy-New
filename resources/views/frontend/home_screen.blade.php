...
@section('main-container')
    <div class="container-fluid container-xxl mt-2 mb-2">
                ...
                <div class="collapse navbar-collapse navbar_setting" id="navbarSupportedContent">
                    <ul class="navbar-nav mb-2 mb-lg-0">
                        ...
                        <li class="me-2  mt-3 mt-lg-0">
                            <select class="form-select form-select-lg select_option mb-3 mb-lg-0 "
                        ...
                        <li>
                            <div class="form-outline me-2 mb-3 mb-lg-0 search_section_div">
                                <input type="search" id="form1" class="form-control search_section"
                                    placeholder="What ?" aria-label="Search-lg" />
                            </div>
                        </li>
                        <li>
                            <div class="form-outline me-2 mb-3 mb-lg-0 search_section_div">
                                <input type="search" id="form2" class="form-control search_section"
                                    placeholder="Where ?" aria-label="Search-lg" />
                            </div>
                        </li>
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu leng_drop_down shadow" aria-labelledby="dropdownMenuLink">
                            ...
                            <li><a class="dropdown-item" href="#" title="Turkish">
                                    <img class="flag_img" src="{{ url('frontend\img\flag\8.png') }}" alt="">
                                    Türkçe
                                </a></li>
    ...
    <div class="container-fluid container-xxl shadow">
        ...
        <div class="row mt-2">
            ...
            <div class="col-4 col-md-2 " style="background: #F8F8F8">
                ...
                <div class="side_navbar">
                    ...
                    <div class="dropdown">
                        <ul class="dropbtn d-flex align-items-center justify-content-between">Vehicle <i
                                class="fa-solid fa-chevron-right side_nav_arrow"></i></ul>
                    ...
                    <div class="dropdown">
                        <ul class="dropbtn d-flex align-items-center justify-content-between">Property <i
                                class="fa-solid fa-chevron-right side_nav_arrow"></i></ul>
                        <li class="dropdown-content">
                            <a class="sub_menu" href="#">Cars</a>
                            <a class="sub_menu" href="#">Buses and Microbuses</a>
                    ...
                    <div class="dropdown">
                        <ul class="dropbtn d-flex align-items-center justify-content-between">Mobile Phones and Tablet <i
                                class="fa-solid fa-chevron-right side_nav_arrow"></i></ul>
                        <li class="dropdown-content">
                            <a class="sub_menu" href="#">Cars</a>
                            <a class="sub_menu" href="#">Buses and Microbuses</a>
                    ...
                    <div class="dropdown">
                        <ul class="dropbtn d-flex align-items-center justify-content-between">Motobikes <i
                                class="fa-solid fa-chevron-right side_nav_arrow"></i></ul>
                        <li class="dropdown-content">
                            <a class="sub_menu" href="#">Cars</a>
                            <a class="sub_menu" href="#">Buses and Microbuses</a>
                    ...
                    <div class="dropdown">
                        <ul class="dropbtn d-flex align-items-center justify-content-between">Electronics <i
                                class="fa-solid fa-chevron-right side_nav_arrow"></i></ul>
                        <li class="dropdown-content">
                            <a class="sub_menu" href="#">Cars</a>
                            <a class="sub_menu" href="#">Buses and Microbuses</a>
                    ...
                    <div class="dropdown">
                        <ul class="dropbtn d-flex align-items-center justify-content-between">Vehicle Parts <i
                                class="fa-solid fa-chevron-right side_nav_arrow"></i></ul>
                        <li class="dropdown-content">
                            <a class="sub_menu" href="#">Cars</a>
                            <a class="sub_menu" href="#">Buses and Microbuses</a>
                    ...
                    <div class="dropdown">
                        <ul class="dropbtn d-flex align-items-center justify-content-between">Health and Beauty <i
                                class="fa-solid fa-chevron-right side_nav_arrow"></i></ul>
                        <li class="dropdown-content">
                            <a class="sub_menu" href="#">Cars</a>
                            <a class="sub_menu" href="#">Buses and Microbuses</a>
                    ...
                    <div class="dropdown">
                        <ul class="dropbtn d-flex align-items-center justify-content-between">Fashions <i
                                class="fa-solid fa-chevron-right side_nav_arrow"></i></ul>
                        <li class="dropdown-content">
                            <a class="sub_menu" href="#">Cars</a>
                            <a class="sub_menu" href="#">Buses and Microbuses</a>
                    ...
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2 c_width">
                        <div class="div item_list">
                            <div class="cornerRibbons bg-org d-flex">
                                <span class="ribbon-text" data-bs-toggle="tooltip" data-bs-placement="top"
                                    title="" data-bs-original-title="Clear Title">Clear Title</span>
                            </div>
                            <div class="row">
                                <a href="{{ url('/buy-product') }}">
                                    <div class="col">
                                        <div class="add_image">
                                            <img class="category_images img-fluid"
                                                src="{{ url('frontend\img\Automobile-premium-plus\1.jpg') }}"
                                                alt="">
                            ...
                            <div class="row p-1">
                                <div class="col-12">
                                    <h5 class="add-title py-1 px-0">
                                        <a href="" class="text_d_none" data-bs-toggle="tooltip"
                            ...
                            <div class="row">
                                <a href="{{ url('/buy-product') }}">
                                    <div class="col">
                                        <div class="add_image">
                                            <img class="category_images img-fluid"
                                                src="{{ url('frontend\img\Automobile-premium-plus\2.jpg') }}"
                                                alt="">
                                            <span class="photo-count">
                                                <i class="fa fa-camera"></i> 12
                                            </span>
                            ...
                            <div class="row">
                                <a href="{{ url('/buy-product') }}">
                                    <div class="col">
                                        <div class="add_image">
                                            <img class="category_images img-fluid"
                                                src="{{ url('frontend\img\Automobile-premium-plus\3.jpg') }}"
                                                alt="">
                                            <span class="photo-count">
                                                <i class="fa fa-camera"></i> 12
                                            </span>
                            ...
                            <div class="row">
                                <a href="{{ url('/buy-product') }}">
                                    <div class="col">
                                        <div class="add_image">
                                            <img class="category_images img-fluid"
                                                src="{{ url('frontend\img\Automobile-premium-plus\4.jpg') }}"
                                                alt="">
                                            <span class="photo-count">
                                                <i class="fa fa-camera"></i> 12
                                            </span>
                            ...
                            <div class="row">
                                <a href="{{ url('/buy-product') }}">
                                    <div class="col">
                                        <div class="add_image">
                                            <img class="category_images img-fluid"
                                                src="{{ url('frontend\img\Automobile-premium-plus\5.jpg') }}"
                                                alt="">
                                            <span class="photo-count">
                                                <i class="fa fa-camera"></i> 12
                                            </span>
                            ...
                            <div class="row">
                                <a href="{{ url('/buy-product') }}">
                                    <div class="col">
                                        <div class="add_image">
                                            <img class="category_images img-fluid"
                                                src="{{ url('frontend\img\Automobile-premium-plus\6.jpg') }}"
                                                alt="">
                                            <span class="photo-count">
                                                <i class="fa fa-camera"></i> 12
                                            </span>
                            ...
                            <div class="row">
                                <a href="{{ url('/buy-product') }}">
                                    <div class="col">
                                        <div class="add_image">
                                            <img class="category_images img-fluid"
                                                src="{{ url('frontend\img\Automobile-premium-plus\7.jpg') }}"
                                                alt="">
                                            <span class="photo-count">
                                                <i class="fa fa-camera"></i> 12
                                            </span>
                            ...
                            <div class="row">
                                <a href="{{ url('/buy-product') }}">
                                    <div class="col">
                                        <div class="add_image">
                                            <img class="category_images img-fluid"
                                                src="{{ url('frontend\img\Automobile-premium-plus\8.jpg') }}"
                                                alt="">
                                            <span class="photo-count">
                                                <i class="fa fa-camera"></i> 12
                                            </span>
                            ...
                            <div class="row">
                                <a href="{{ url('/buy-product') }}">
                                    <div class="col">
                                        <div class="add_image">
                                            <img class="category_images img-fluid"
                                                src="{{ url('frontend\img\Automobile-premium-plus\9.jpg') }}"
                                                alt="">
                                            <span class="photo-count">
                                                <i class="fa fa-camera"></i> 12
                                            </span>
                            ...
                            <div class="row">
                                <a href="{{ url('/buy-product') }}">
                                    <div class="col">
                                        <div class="add_image">
                                            <img class="category_images img-fluid"
                                                src="{{ url('frontend\img\Automobile-premium-plus\10.jpg') }}"
                                                alt="">
                                            <span class="photo-count">
                                                <i class="fa fa-camera"></i> 12
                                            </span>
                            ...
                            <div class="row">
                                <a href="{{ url('/buy-product') }}">
                                    <div class="col">
                                        <div class="add_image">
                                            <img class="category_images img-fluid"
                                                src="{{ url('frontend\img\Automobile-premium-plus\11.jpg') }}"
                                                alt="">
                                            <span class="photo-count">
                                                <i class="fa fa-camera"></i> 12
                                            </span>
                            ...
                            <div class="row">
                                <a href="{{ url('/buy-product') }}">
                                    <div class="col">
                                        <div class="add_image">
                                            <img class="category_images img-fluid"
                                                src="{{ url('frontend\img\Automobile-premium-plus\12.jpg') }}"
                                                alt="">
                                            <span class="photo-count">
                                                <i class="fa fa-camera"></i> 12
                                            </span>
                            ...
                            <div class="row">
                                <a href="{{ url('/buy-product') }}">
                                    <div class="col">
                                        <div class="add_image">
                                            <img class="category_images img-fluid"
                                                src="{{ url('frontend\img\Automobile-premium-plus\13.jpg') }}"
                                                alt="">
                                            <span class="photo-count">
                                                <i class="fa fa-camera"></i> 12
                                            </span>
                            ...
                            <div class="row">
                                <a href="{{ url('/buy-product') }}">
                                    <div class="col">
                                        <div class="add_image">
                                            <img class="category_images img-fluid"
                                                src="{{ url('frontend\img\Automobile-premium-plus\15.jpg') }}"
                                                alt="">
                                            <span class="photo-count">
                                                <i class="fa fa-camera"></i> 12
                                            </span>
                            ...
                            <div class="row">
                                <a href="{{ url('/buy-product') }}">
                                    <div class="col">
                                        <div class="add_image">
                                            <img class="category_images img-fluid"
                                                src="{{ url('frontend\img\Automobile-premium-plus\16.jpg') }}"
                                                alt="">
                                            <span class="photo-count">
                                                <i class="fa fa-camera"></i> 12
                                            </span>
