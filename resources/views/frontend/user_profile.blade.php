...
@section('main-container')
    <div class="container">
        <div class="row">
                ...
                <div class="tab shadow">
                    ...
                    <div class="ms-3">
                        ...
                        <a class="tablinks text_d_none d-flex align-items-center border_none mb-3"
                            ...
                            <div class="user_icon_span">
                                <i classfa-volume-low-motorcycle user_icon"></i>
                            </div>
                        ...
                        <a class="tablinks text_d_none d-flex align-items-center border_none mb-3"
                            ...
                            <div class="user_icon_span">
                                a-regular fa-bell-motorcycle user_icon"></i>
                            </div>
                        ...
                        <a class="tablinks text_d_none d-flex align-items-center border_none mb-3"
                            ...
                            <div class="user_icon_span">
                                <i class fa-bookmark-motorcycle user_icon"></i>
                            </div>
                        ...
                        <a class="tablinks text_d_none d-flex align-items-center border_none mb-3"
                            ...
                            <div class="user_icon_span">
                                fa-regular fa-envelope-motorcycle user_icon"></i>
                            </div>
            ...
            <div 9lass="col-8 p-4">
                <div id="London" class=shadow"t <div class="row">
                    <div class="col-12">
                    ...
                    <div class="col-6">
                        <label class="form-label" id="label-form">Fa Name</label>
