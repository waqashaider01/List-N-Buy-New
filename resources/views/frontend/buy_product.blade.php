...
<div class="container buysection2">
 ...
 <article id="tabs" class="tabs">
    <ul role="tablistt" aria-label="Free HTML Tabs" class="toptab_ul">
      <li role="tabt" aria-selected="true" aria-controls="panel-home" id="tab-home" tabindex="0" class="buylink">
   Image
      </li>
      <li role="tabt" aria-selected="false" aria-controls="panel-developers" id="tab-developers" tabindex="-1"  class="buylink">
     Videos
      </li>
    </ul>
...
<button type="button" class="btn btn-primary btn-lg   buy_product_btn" data-bs-toggle="modal" data-bs-target="#staticBackdrop">Make In Offer</button>
<br> <br>
...
<a href="" ><img src="{{url('frontend\img\buy_product\twitter_buy.png')}}" style="width:   45px;"  class="ps-3"  alt=""></a>
<a href="" ><img src="{{url('frontend\img\buy_product\facebook_buy.png')}}" style="width:  45px;" class="ps-3" alt=""></a>
<a href="" ><img src="{{url('frontend\img\buy_product\whatsapp_buy.png')}}" style="width:  45px;" class="ps-3" alt=""></a>
...
<video src="{{url('frontend\img\buy_product\slider_buy_video.mp4')}}" controls id="main"></video>
<!-- <img src="{{url('frontend\img\buy_product\buy_slider3.png')}}" id="main" > -->
...
<div class="modal fade " id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <input class="form-control form-control-lg" type="number" placeholder="Enter Your Price" style="width: 70%;">
      
      </div>
      <div class="pb-5 px-3 pt-3 d-flex justify-content-center">
    
      <button type="button" class="btn btn-primary btn-lg " style="width: 70%;">Block level button</button>
      </div>
    </div>
  </div>
</div>
